...
- July 11, 2025. Added "Remove stage" functionality: each task now has a button aligned with the completion checkbox for single-click deletion of individual stages
