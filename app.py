                                        ...
                                        with task_container:
                                            ...
                                            with col3:
                                                ...
                                                manual_time = st.text_input(
                                                    ...
                                                    on_change=None  # Will trigger on Enter
                                                )
                                                
                                                # Process manual time entry when user presses Enter
                                                if manual_time and manual_time != "":
                                                    try:
                                                        ...
                                                        if len(time_parts) == 3:
                                                            ...
                                                            if total_seconds > 0:
                                                                ...
                                                                try:
                                                                    ...
                                                                    st.session_state[f"manual_{task_key}"] = ""
                                                                    st.rerun()
